...
def run_simulation(args, client):
    ...
    try:
        ...
        SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=0, z=2.4), carla.Rotation(yaw=160)), 
                      vehicle, {}, display_pos=[1, 0])
        SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=0.2, z=2.4), carla.Rotation(yaw=-160)), 
